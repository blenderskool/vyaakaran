<template>
  <li class="flex items-center border-t-2 bg-gray-900 shadow" :class="{ 'border-transparent opacity-50': !isActive, 'border-cyan-300': isActive }">
    <slot>
      <component
