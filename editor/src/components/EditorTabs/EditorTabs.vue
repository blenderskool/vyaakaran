  ...
  <header class="h-7 relative z-20 flex items-center justify-between bg-gray-850 border-b border-gray-900">
    ...
    <div class="flex justify-between items-center">
      <Menu as="div" class="relative inline-block text-left mr-5">
        <div>
          <MenuButton class="inline-flex justify-center w-full rounded outline-none border text-xs border-cyan-300 hover:outline-none p-1 text-cyan-300 bg-cyan-400 bg-opacity-10 hover:bg-opacity-20 focus:outline-none">
            Select Example
            <svg
