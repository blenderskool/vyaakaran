...
export default defineComponent({
	...
	setup() {
		...
		if (import.meta.env.PROD && typeof window !== undefined) {
			...
			script.src =
				"https://www.googletagmanager.com/gtag/js?id=UA-82138003-6";
			script.async = true;
			script.defer = true;
